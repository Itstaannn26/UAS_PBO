package id.ac.poliban.vb.e020320040.contactappe020320040;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public DbHelper(@Nullable Context context) {
        super(context, id.ac.poliban.vb.e020320040.contactappe020320040.Constants.DATABASE_NAME, null, Constants.DATABASE_VERSION);
    }
